    ...
    <div class="w-full centerr">
        <div v-if="haveInfo" class=" p-4">
            ...
            <div class="border-4 p-8">
                ...
                <p><b>PublishDate:</b> <span class="ann-publish-date">{{
                    changeDateTimeFormat(announcementDetail.publishDate) }}</span></p>
                <p><b>CloseDate:</b> <span class="ann-close-date">{{ changeDateTimeFormat(announcementDetail.closeDate)
                }}</span></p>
